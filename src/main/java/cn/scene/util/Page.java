...
public class Page<T> implements Serializable {
    ...
    public Integer getTotalPage() {
        int temp = (int) totalRecord / rows;
        this.totalPage = (totalRecord % rows == 0 ? temp : temp + 1);
        return totalPage;
    }
    ...
    public String toString() {
        return "Page [page=" + page + ", rows=" + rows + ", totalRecord=" + totalRecord + ", firstPage=" + firstPage + ", endPage=" + endPage + ", list=" + list + ", keyWord=" + keyWord
                + ", paramEntity=" + paramEntity + ", start=" + start + ", totalPage=" + totalPage + ", pageMap=" + pageMap + "]";
    }
